...
// v14: root-family matching (ordered radicals, all-but-one, best candidate wins) so
// other inflections of weak roots highlight — client and server now anchor identically.
// v13: skeletons drop non-letters so dotted roots (ח.י.ה) match, and nouns get
// their affixes segmented instead of one lumped root chunk.
